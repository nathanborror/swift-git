...
public struct GitError: Error, CustomStringConvertible, LocalizedError, Sendable {
    ...
    static func checkAndReturn(apiName: String, closure: (inout OpaquePointer?) -> Int32) throws
        -> OpaquePointer
    {
    ...
    static func checkAndReturnOID(apiName: String, closure: (inout git_oid) -> Int32) throws
        -> ObjectID
    {
        var oid = git_oid()
